...
int main(void)
{
	...
	printf("\n");
	replace(addresses, "Don", "Don.test1@carleton.ca");
	print_dictionary(addresses);
	printf("\n");
	replace(addresses, "Lynn", "Lynn.test2@carleton.ca");
	print_dictionary(addresses);
	printf("\n");
	replace(addresses, "Donny", "donny.test3@carleton.ca");
	print_dictionary(addresses);
	printf("\n");
	clear(addresses);
	print_dictionary(addresses);
